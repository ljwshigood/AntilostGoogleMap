...
public class DatabaseManager {
	...
	public void updateDeviceLatLogIsConnect(String lat,String lng) {
		...
		Log.e("updateDeviceLatLogIsConnect", "####################sql " + sql);
		mSQLiteDatabase.execSQL(sql);
	}
	
	public void testupdateDeviceLatLogIsConnect(String lat,String lng) {
		String sql = "update device_set set latitude = \"%s\",longitude =\"%s\" where islocation = 1 and connect = 0";
		sql = String.format(sql, lat, lng);
		Log.e("updateDeviceLatLogIsConnect", "####################sql " + sql);
		mSQLiteDatabase.execSQL(sql);
	}
